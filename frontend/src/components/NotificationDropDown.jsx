...
const NotificationDropDown = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="absolute right-0 mt-1 w-[370px] bg-white rounded-md border-[1.5px] border-black shadow-[2px_2px_0px_#000000] z-50">
      <div className="py-2">
        ...
        <div className="overflow-y-auto max-h-[400px]">
          {notifications.map((notification) => (
            <div 
              key={notification.id} 
              className="flex items-center px-4 py-3 cursor-pointer border-b last:border-b-0 border-gray-300 bg-white hover:bg-gray-100 transition-colors duration-200"
            >
