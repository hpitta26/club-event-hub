...
function EventModalCard({
  ...
  return (
    <div className="container flex gap-3 w-full px-4 py-4 bg-white rounded-xl hover:bg-[#f7f7f5] transition border-[1.5px] border-black hover:shadow-[3px_3px_0px_#000000]">
      ...
      {!upcoming ? (
        <div className="flex items-center">
          <div
            className="bg-green-400 rounded-md py-1 px-1 cursor-pointer border-[1.5px] border-black"
            onClick={openSurvey}
          >
