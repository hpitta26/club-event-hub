...
function EventListCard({
  ...
  return (
    <div className="border shadow-[3px_3px_0_#000] hover:shadow-[4px_4px_0_#000] transition-all duration-200 bg-white rounded-[12px] border-black flex max-w-[500px] w-full transform hover:-translate-y-1">
