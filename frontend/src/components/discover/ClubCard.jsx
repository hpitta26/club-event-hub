...
function ClubCard({
  ...
  return (
    <div
      className="relative w-[200.5px] h-[250.75px] bg-[#F0EFEB] border-2 border-black rounded-xl shadow-sm
                    hover:shadow-md transition-transform transform hover:scale-[1.02] p-2.5 flex flex-col cursor-pointer"
    >
      {/* Event Banner */}
      <div className="relative w-[177.5px] h-[123.75px] mb-2.5 border-2 border-black rounded-lg overflow-hidden">
        <p
      ...
      <div className="absolute bottom-[12.5px] left-[15px] flex justify-between items-center w-[170.5px]">
        {/* Going */}
