...
function EditEventModal({ event, onClose, onEventUpdate }) {
  ...
  return (
    <div className="flex flex-col bg-[#FFFAFD] p-6 gap-5 w-8/12 max-w-6xl h-[90%] overflow-y-auto rounded-lg border-black border-2 shadow-[3px_3px_0px_#000000]">
        ...
        <div className="w-full max-w-[860px] space-y-2">
          ...
          <div className="flex justify-between items-center">
            <div className={"flex items-center gap-5 "}>
              <FiX
                className="transform cursor-pointer text-4xl hover:text-blue-500 hover:scale-105 duration-300 transition"
                onClick={onClose}
              />
            ...
            <button
              ...
              className="bg-[#FD4EB7] border-[1.5px] border-black rounded-[4px] py-2 px-4 text-black font-medium hover:bg-[#E93DA6] transition hover:shadow-[2px_2px_0_#000] ease-in-out duration-300"
            >
              Save
            </button>
          </div>
          ...
          <div className={activeTab === "details" ? "block" : "hidden"}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-2">
              ...
              <div className="flex flex-col">
                <div className="w-full max-w-[416px] h-[220px] border-[2px] border-black shadow-[2px_2px_0px_#000000] rounded-lg relative">
                  <img
          ...
          <div className={activeTab === "schedule" ? "block" : "hidden"}>
            <ClubHeatmap
              ...
              preselected_start_time={formData.start_time}
              preselected_end_time={formData.end_time}
            />
          </div>
        </div>
      </section>
