      ...
      <div className="w-full max-w-[860px] space-y-8">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="bg-[#FD4EB7] border-[1.5px] border-black rounded-[4px] py-2 px-3 text-black font-medium hover:bg-[#E93DA6] hover:shadow-[2px_2px_0_#000] ease-in-out duration-300"
          >
            Create Event
          </button>
        </div>
