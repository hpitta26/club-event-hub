...
const FormContainer = ({
  ...
  const renderField = (field) => {
    if (field.type === "radio"){
      ...
      return(<div className="flex flex-col gap-2" key={field.name}>
      <label
        htmlFor={field.name}
        className="text-sm sm:text-base font-bold"
      >
  ...
  return (
    <div className="bg-stone-400 w-11/12 min-w-72 max-w-sm sm:w-96 md:w-96 lg:w-96 h-auto min-h-96 mx-auto px-6 sm:px-8 md:px-10 pt-6 pb-10 rounded-xl flex flex-col justify-center gap-4">
