...
function EventDetailsCard({
  ...
  return (
    <div className="fixed top-0 right-0 z-50 h-screen flex items-start justify-end p-4">
      ...
      />
      <div
        className="event-details-card container flex flex-col items-start justify-start bg-neutral-200 p-6 gap-4 w-96 shadow-lg h-[calc(100vh-2rem)] overflow-y-auto z-50"
      ...
      >
        ...
        <div className="flex flex-row justify-between items-center w-full mt-2">
          ...
          <button className="bg-black text-white py-1 px-4 rounded-md text-sm font-medium">
            RSVP
          </button>
        </div>
        ...
        <div className="w-full">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <p className="text-sm text-gray-600 ml-3">{attendees} GOING</p>
            </div>
