      ...
      <div className="container flex flex-col  bg-[#F5F5F5] w-72 h-95 px-4 py-5 rounded-3xl"> 
        ...
        <div className="flex flex-col justify-start gap-1">
          ...
          <div className="flex flex-col">
            ...
            <img src={dummyEventCardCover} alt="" className="rounded-lg w-full h-48 object-cover object-bottom" />
          </div>
          ...
          <div className="flex flex-row gap-1 items-center">
            <div className="w-4 h-4 rounded-full overflow-hidden">
              <img src={dummyInitLogo} alt="Logo" className="w-full h-full object-cover" />
            </div>
        ...
        <div className="flex flex-row gap-1  items-center mt-8 justify-between">
          ...
          <div className="flex -space-x-3 items-center">
            {[...Array(4)].map((_, index) => (
              <FaCircleUser key={index} className="text-gray-600 w-7 h-7 ring-2 bg-white ring-white rounded-full" />
            ))}
            <div className="w-8 h-6 px-4 bg-[#D0FDA0] text-black  rounded-full ring-2 ring-white  flex items-center justify-center text-center">
              <p className="text-[8px]  font-bold text-center">
                <span className="font-black">+</span> 191
              </p>
            </div>
          </div>
