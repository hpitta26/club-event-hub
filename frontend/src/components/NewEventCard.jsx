...
function NewEventCard({
    ...
    return (
        <>
            <div
                ref={cardRef}
                className="relative w-[237.5px] h-[268.75px] bg-white border-[2px] border-black rounded-xl
                        hover:shadow-[4px_4px_0px_#000000] transition-transform transform hover:scale-[1.02] flex flex-col cursor-pointer"
                onClick={handleOnClick}
            >
                {/* Event Banner */}
                <div className="relative w-full h-[123.75px] border-b-[2px] border-black overflow-hidden rounded-t-[10px]">
                    <div className="flex justify-between w-full">
                        <p className="absolute left-1.5 top-1.5 bg-blue-500 text-black px-1.5 py-0.625 rounded-md text-[10px] font-medium border  border-black z-10">
                            {formatDate(date)}
                        </p>
                        <p className="absolute right-1.5 top-1.5 bg-yellow-500 text-black px-1.5 py-0.625 rounded-md text-[10px] font-medium border border-black z-10">
                            {spiritPoints} pts
                        </p>
                    </div>
                    <img
                ...
                {/* Title */}
                <p className="absolute top-[137.5px] left-[12.5px] w-[207.5px] h-[23.75px] font-semibold text-[20px] leading-[23.75px]">
                    {handleTitleLength(title)}
                </p>

                {/* Host & Location */}
                <div className="absolute top-[166.75px] left-[12.5px] flex items-center gap-1.5 mb-1.25">
                    <img
                        src={hostLogo}
                        alt="Host Logo"
                ...
                <div className="absolute top-[189.5px] left-[12.5px] flex items-center gap-1.5">
                ...
                <div className="absolute bottom-[12.5px] left-[12.5px] flex items-center gap-1.5">
                    {/* Avatars */}
                ...
                {/* Spots Left */}
                <div className="absolute bottom-[12.5px] right-[12.5px]">
                    <p
                        className="text-[12.5px]"
                        style={{ color: spotsLeftColor }}
                    >
